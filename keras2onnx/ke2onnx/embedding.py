...
def convert_keras_embed(scope, operator, container):
    ...
    casted_name = scope.get_unique_variable_name('casted')
    apply_cast(scope, reshaped_input_name, casted_name, container, to=onnx_proto.TensorProto.INT32)
    ...
    container.add_node(op_type, [embedding_tensor_name, casted_name], operator.output_full_names, **attrs)
