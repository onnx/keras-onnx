...
def on_parsing_keras_layer(graph, node_list, layer, kenode, model, varset, prefix=None):
    ...
    for n_, i_ in enumerate(inputs):
        ...
        var_type = adjust_input_batch_size(infer_variable_type(i_, varset.target_opset, kenode.input_shapes[n_]))
    ...
    for n_, o_ in enumerate(outputs):
        ...
        o1 = varset.get_local_variable_or_declare_one(oname, infer_variable_type(o_, varset.target_opset, kenode.output_shapes[n_]))
