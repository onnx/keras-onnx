...
class TestCycleGAN(unittest.TestCase):
    ...
    def test_CycleGAN(self):
        ...
        self.assertTrue(run_onnx_runtime(onnx_model.graph.name, onnx_model, {keras_model.input_names[0]: x, keras_model.input_names[1]: y}, expected, self.model_files, rtol=1.e-2, atol=2.e-3))
